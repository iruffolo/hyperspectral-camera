...
public class RecordModeFragmentDirections {
  ...
  public static ActionRecordModeToPreview actionRecordModeToPreview(@NonNull String cameraId,
    ...
    return new ActionRecordModeToPreview(cameraId, width, height, fps, dynamicRange, previewStabilization, filterOn, useHardware);
  }

  @NonNull
  public static ActionRecordModeToFilter actionRecordModeToFilter(@NonNull String cameraId,
      int width, int height, int fps, long dynamicRange, boolean previewStabilization) {
    return new ActionRecordModeToFilter(cameraId, width, height, fps, dynamicRange, previewStabilization);
  }
