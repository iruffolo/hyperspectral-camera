...
public class DynamicRangeFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private DynamicRangeFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private DynamicRangeFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static DynamicRangeFragmentArgs fromBundle(@NonNull Bundle bundle) {
    DynamicRangeFragmentArgs __result = new DynamicRangeFragmentArgs();
    bundle.setClassLoader(DynamicRangeFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    DynamicRangeFragmentArgs that = (DynamicRangeFragmentArgs) object;
  ...
  public String toString() {
    return "DynamicRangeFragmentArgs{"
  ...
  public static class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(DynamicRangeFragmentArgs original) {
    ...
    @NonNull
    public DynamicRangeFragmentArgs build() {
      DynamicRangeFragmentArgs result = new DynamicRangeFragmentArgs(arguments);
      return result;
    }
